...
export default function LoginScreen() { return ( <View style={styles.container}> <Text style={styles.title}>Mintara Login</Text> <Text>Email/password signup coming soon</Text> </View> ); }
